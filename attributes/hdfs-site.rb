...
default[:Hadoop][:HDFS][:dfsNameDir] = [ "/data/dfs/name" ]
default[:Hadoop][:HDFS][:dfsDataDir] = [ "/data/dfs/data" ]
default[:Hadoop][:HDFS][:replication] = "3"
set_unless[:Hadoop][:HDFS][:dfsSecondaryHttpAddress] = "localhost:50090"
